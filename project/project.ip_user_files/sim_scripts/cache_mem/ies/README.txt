...
#
# Generated by export_simulation on Tue Jan 05 15:56:14 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './cache_mem.sh' script.

./cache_mem.sh -reset_run
...
./cache_mem.sh -noclean_files

For more information on the script, please type './cache_mem.sh -help'.
